...
#ifndef _sc95f8x1x_USCI2_H_
#define	_sc95f8x1x_USCI2_H_
...
void USCI2_UART_Init(uint32_t UART1Fsys, uint32_t BaudRate, USCI2_UART_Mode_TypeDef Mode, USCI2_UART_RX_TypeDef RxMode); 
