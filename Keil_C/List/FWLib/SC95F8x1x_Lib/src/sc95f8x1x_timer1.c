...
*函数功能：TIMER1基本设置配置函数
*入口参数：TIM1_PrescalerSelection	预分频选择
		   TIM1_CountMode			计数/定时模式选择
*出口参数：void
**************************************************/
...
*入口参数：uint16_t TIM1_SetCounter	配置计数初值
*出口参数：void
**************************************************/
...
*入口参数：uint8_t TIM1_SetCounter	配置计数初值
*出口参数：void
**************************************************/
...
*函数功能：TIMER1工作模式配置函数
*入口参数：TIM1_WorkMode_TypeDef TIM1_WorkMode 	TIMER1工作模式选择
...
*入口参数：uint16_t TIM1_SetCounter	配置TIMER1重载值	
*出口参数：void
**************************************************/
