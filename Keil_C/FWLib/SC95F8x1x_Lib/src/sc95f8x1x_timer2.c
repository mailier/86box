...
*函数功能：TIM2基本设置配置函数
*入口参数：
		   TIM2_CountMode			计数/定时模式选择
		   TIM2_CountDirection		计数方向选择
*出口参数：void
**************************************************/
...
*入口参数：uint16_t TIM2_SetCounter	配置计数初值
*出口参数：void
**************************************************/
...
*函数功能：TIMER2工作模式配置函数
*入口参数：TIM2_WorkMode_TypeDef TIM2_WorkMode 	TIMER2工作模式选择
...
*入口参数：FunctionalState NewState		EXEN2使能选择
*出口参数：void
*****************************************************/
...
*函数功能：获得TIMER2中断标志状态
*入口参数：TIM2_Flag  		TIMER2标志选择
*出口参数：FlagStatus	    TIMER2中断标志状态	
*****************************************************/
